...
/* themes/wosh/templates/navigation/menu.html.twig */
class __TwigTemplate_856e2275ac1ab67ff9419a4bc15282ba016b7a876b960ab5f65fff793af3f371 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "nav menu menu-parent"], "method", false, false, true, 33), 33, $this->source), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return "themes/wosh/templates/navigation/menu.html.twig";
    }
    ...
    {
        return new Source("", "themes/wosh/templates/navigation/menu.html.twig", "/var/www/html/test.karessme.com/themes/wosh/templates/navigation/menu.html.twig");
    }
