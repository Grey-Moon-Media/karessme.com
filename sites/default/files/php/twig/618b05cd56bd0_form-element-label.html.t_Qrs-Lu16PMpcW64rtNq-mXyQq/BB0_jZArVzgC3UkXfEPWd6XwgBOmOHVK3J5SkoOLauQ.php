...
class __TwigTemplate_e7403c2b001bd2728a588277dcf01871c8e69ddb2a9723218f6e8fbea5b72bbf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["required"] ?? null)) ? ("form-required") : (""))];
        ...
        if (( !twig_test_empty(($context["title"] ?? null)) || ($context["required"] ?? null))) {
            ...
            echo ">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title"] ?? null), 26, $this->source), "html", null, true));
            echo "</label>";
        }
    }
    ...
    {
        return new Source("", "core/modules/system/templates/form-element-label.html.twig", "/var/www/html/test.karessme.com/core/modules/system/templates/form-element-label.html.twig");
    }
