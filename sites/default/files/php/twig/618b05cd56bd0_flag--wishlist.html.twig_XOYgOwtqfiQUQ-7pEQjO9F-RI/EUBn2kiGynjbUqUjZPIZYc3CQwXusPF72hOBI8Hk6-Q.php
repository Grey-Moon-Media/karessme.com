...
/* themes/wosh/templates/flag/flag--wishlist.html.twig */
class __TwigTemplate_3e31519ba48e8a6a5a16ffc8ea30872102268a02751ce498ec4a5b3babbb0a8f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
        ...
        echo "\"><a";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "flag-link"], "method", false, false, true, 41), 41, $this->source), "html", null, true));
        echo "><span class=\"flag-title\">";
        ...
        echo "</span> <i class=\"fa ion-ios-heart\"></i></a></div>
";
    ...
    {
        return "themes/wosh/templates/flag/flag--wishlist.html.twig";
    }
    ...
    {
        return new Source("", "themes/wosh/templates/flag/flag--wishlist.html.twig", "/var/www/html/test.karessme.com/themes/wosh/templates/flag/flag--wishlist.html.twig");
    }
